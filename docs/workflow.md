...
5. After implementation and required verification, the agent records completion. Essential user-only validation keeps the same plan attached, with a bold accent **awaiting validation notice at the end of the turn** and precise instructions. Optional feedback does not hold completion open.
