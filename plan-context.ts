import { buildPlanReminder, BUILD_BOUNDARY_GUIDANCE, BUILD_TASK_GUIDANCE, PLAN_READ_ONLY_GUIDANCE, buildPlanStepReminder, buildPlanStepWaitingReminder, VERIFICATION_GUIDANCE } from "./prompts.ts";
